// ignore_for_file: avoid_print, non_constant_identifier_names, file_names, unnecessary_new, constant_identifier_names



class LogUtil {
  static String _separator = "=";
  static String _split = "$_separator$_separator$_separator$_separator$_separator$_separator$_separator$_separator$_separator";
  ...
  static void init({String title="", bool isDebug=false,int limitLength=100}) {
    _title = title;
    _isDebug = isDebug;
